...
public class TreeSetexample {
    public static void main(String[] args) {
        ...
        * мы использовали не строки, а свои классы:*/
...
/*Объект TreeSet мы не сможем типизировать данным классом, поскольку в случае добавления объектов TreeSet не будет
